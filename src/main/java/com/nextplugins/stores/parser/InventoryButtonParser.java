...
public final class InventoryButtonParser {
    ...
    public InventoryButton parse(ConfigurationSection section) {
        ...
        val itemStack = TypeUtil.convertFromLegacy(section.getString("material"), (byte) section.getInt("data"));
        ...
        return InventoryButton.builder()
                ...
                .materialData(
                        itemStack == null
                                ? new MaterialData(Material.BARRIER, 0, false)
                                : MaterialData.of(itemStack, false))
